...
# Hierarchical cell: h264
proc create_hier_cell_h264 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" create_hier_cell_h264() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir I -from 0 -to 0 -type rst S00_ARESETN1
...
CONFIG.NUM_MI {1} \
  ...
  # Create instance: h264enc_with_axi_0, and set properties
  set h264enc_with_axi_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:h264enc_with_axi:1.0 h264enc_with_axi_0 ]

  # Create instance: rgb2yuv_with_axi_0, and set properties
  set rgb2yuv_with_axi_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:rgb2yuv_with_axi:1.0 rgb2yuv_with_axi_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_interconnect_1/S00_AXI] [get_bd_intf_pins rgb2yuv_with_axi_0/axi_m]
  connect_bd_intf_net -intf_net axi_apb_bridge_0_APB_M [get_bd_intf_pins axi_apb_bridge_0/APB_M] [get_bd_intf_pins h264enc_with_axi_0/apb_s]
  connect_bd_intf_net -intf_net axi_apb_bridge_1_APB_M [get_bd_intf_pins axi_apb_bridge_1/APB_M] [get_bd_intf_pins rgb2yuv_with_axi_0/apb]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_2_M00_AXI [get_bd_intf_pins AXI4_LITE] [get_bd_intf_pins axi_apb_bridge_0/AXI4_LITE]
  connect_bd_intf_net -intf_net h264enc_with_axi_0_axi_m [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins h264enc_with_axi_0/axi_m]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins AXI4_LITE1] [get_bd_intf_pins axi_apb_bridge_1/AXI4_LITE]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins ARESETN] [get_bd_pins axi_interconnect_0/ARESETN]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins axi_apb_bridge_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins h264enc_with_axi_0/axi_rstn] [get_bd_pins h264enc_with_axi_0/enc_rstn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ACLK1] [get_bd_pins axi_apb_bridge_1/s_axi_aclk] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins rgb2yuv_with_axi_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_pins ACLK] [get_bd_pins axi_apb_bridge_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins h264enc_with_axi_0/axi_clk] [get_bd_pins h264enc_with_axi_0/enc_clk]
  connect_bd_net -net rst_processing_system7_0_fclk0_interconnect_aresetn [get_bd_pins ARESETN1] [get_bd_pins axi_interconnect_1/ARESETN]
  connect_bd_net -net rst_processing_system7_0_fclk0_peripheral_aresetn [get_bd_pins S00_ARESETN1] [get_bd_pins axi_apb_bridge_1/s_axi_aresetn] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins rgb2yuv_with_axi_0/rstn]
...
CONFIG.NUM_PORTS {7} \
  ...
  # Create instance: h264
  create_hier_cell_h264 [current_bd_instance .] h264
...
CONFIG.PCW_ACT_FPGA3_PERIPHERAL_FREQMHZ {30.303030} \
...
CONFIG.PCW_FCLK3_PERIPHERAL_DIVISOR0 {33} \
...
CONFIG.PCW_FPGA3_PERIPHERAL_FREQMHZ {30} \
...
CONFIG.CONST_WIDTH {3} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins h264/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP2]
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins h264/M00_AXI1] [get_bd_intf_pins processing_system7_0/S_AXI_HP1]
  connect_bd_intf_net -intf_net axi_interconnect_2_M00_AXI [get_bd_intf_pins axi_interconnect_2/M00_AXI] [get_bd_intf_pins h264/AXI4_LITE]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins h264/AXI4_LITE1] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]
  ...
  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_2/ARESETN] [get_bd_pins h264/ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins h264/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins h264/ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK3] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_fclk1/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_fclk0/ext_reset_in] [get_bd_pins video/system_reset]
  connect_bd_net -net rst_processing_system7_0_fclk0_interconnect_aresetn [get_bd_pins h264/ARESETN1] [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_fclk0/interconnect_aresetn] [get_bd_pins video/control_interconnect_reset_n]
  connect_bd_net -net rst_processing_system7_0_fclk0_peripheral_aresetn [get_bd_pins btns_gpio/s_axi_aresetn] [get_bd_pins h264/S00_ARESETN1] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M06_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M07_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M08_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rgbleds_gpio/s_axi_aresetn] [get_bd_pins rst_processing_system7_0_fclk0/peripheral_aresetn] [get_bd_pins swsleds_gpio/s_axi_aresetn] [get_bd_pins system_interrupts/s_axi_aresetn] [get_bd_pins video/control_reset_n]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins concat_interrupts/In1] [get_bd_pins concat_interrupts/In2] [get_bd_pins concat_interrupts/In3] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins concat_interrupts/In4] [get_bd_pins xlconstant_1/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C50000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video/hdmi_out/frontend/axi_dynclk/s00_axi/reg0] SEG_axi_dynclk_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x41230000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video/hdmi_in/frontend/axi_gpio_hdmiin/S_AXI/Reg] SEG_axi_gpio_hdmiin_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video/hdmi_in/color_convert/s_axi_AXILiteS/Reg] SEG_color_convert_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video/hdmi_out/color_convert/s_axi_AXILiteS/Reg] SEG_color_convert_Reg14
  create_bd_addr_seg -range 0x00010000 -offset 0x83C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs h264/h264enc_with_axi_0/apb_s/apb_s] SEG_h264enc_with_axi_0_apb_s
  create_bd_addr_seg -range 0x00010000 -offset 0x41240000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video/hdmi_out/frontend/hdmi_out_hpd_video/S_AXI/Reg] SEG_hdmi_out_hpd_video_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video/hdmi_in/pixel_pack/s_axi_AXILiteS/Reg] SEG_pixel_pack_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs h264/rgb2yuv_with_axi_0/apb_s/apb_s] SEG_rgb2yuv_with_axi_0_apb_s
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C60000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video/hdmi_out/frontend/vtc_out/ctrl/Reg] SEG_vtc_out_Reg
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces h264/h264enc_with_axi_0/axi_m] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_processing_system7_0_HP2_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces h264/rgb2yuv_with_axi_0/axi_m] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_0_HP1_DDR_LOWOCM
...
#  -string -flagsOSRD
preplace port btns_4bits -pg 1 -y 920 -defaultsOSRD
preplace port DDR -pg 1 -y 210 -defaultsOSRD
preplace port hdmi_out_ddc -pg 1 -y 250 -defaultsOSRD
preplace port leds_4bits -pg 1 -y 1070 -defaultsOSRD
preplace port hdmi_out -pg 1 -y 540 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 230 -defaultsOSRD
preplace port sws_2bits -pg 1 -y 1050 -defaultsOSRD
preplace port hdmi_in -pg 1 -y 480 -defaultsOSRD
preplace port rgbleds_6bits -pg 1 -y 760 -defaultsOSRD
preplace port hdmi_in_ddc -pg 1 -y 500 -defaultsOSRD
preplace portBus hdmi_out_hpd -pg 1 -y 580 -defaultsOSRD
preplace portBus hdmi_in_hpd -pg 1 -y 600 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 1 -y 1130 -defaultsOSRD
preplace inst system_interrupts -pg 1 -lvl 3 -y 820 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 1 -y 1210 -defaultsOSRD
preplace inst swsleds_gpio -pg 1 -lvl 4 -y 1070 -defaultsOSRD
preplace inst rst_processing_system7_0_fclk0 -pg 1 -lvl 1 -y 570 -defaultsOSRD
preplace inst concat_interrupts -pg 1 -lvl 2 -y 1190 -defaultsOSRD
preplace inst h264 -pg 1 -lvl 3 -y 140 -defaultsOSRD
preplace inst rgbleds_gpio -pg 1 -lvl 4 -y 760 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 1 -y 360 -defaultsOSRD
preplace inst proc_sys_reset_fclk1 -pg 1 -lvl 2 -y 360 -defaultsOSRD
preplace inst btns_gpio -pg 1 -lvl 4 -y 930 -defaultsOSRD
preplace inst video -pg 1 -lvl 3 -y 550 -defaultsOSRD
preplace inst axi_interconnect_2 -pg 1 -lvl 2 -y 130 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 2 -y 770 -defaultsOSRD
...
preplace netloc processing_system7_0_FCLK_CLK3 1 0 5 20 250 360 250 810 330 1220 470 1630
preplace netloc iop_interrupts_irq 1 3 1 1240
preplace netloc btns_gpio_ip2intc_irpt 1 1 4 390 1070 NJ 1000 NJ 1000 1630
preplace netloc swsleds_gpio_ip2intc_irpt 1 1 4 400 1300 NJ 1300 NJ 1300 1630
preplace netloc processing_system7_0_axi_periph_M08_AXI 1 2 1 810
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 2 2 790 1050 NJ
preplace netloc proc_sys_reset_fclk1_interconnect_aresetn 1 2 1 790
preplace netloc processing_system7_0_M_AXI_GP0 1 1 4 390 260 NJ 260 NJ 140 1630
preplace netloc video_dout 1 1 3 400 1080 NJ 1080 1200
preplace netloc hdmi_out_hpd_video_gpio_io_o 1 3 2 NJ 580 NJ
preplace netloc rgbled_gpio_GPIO 1 4 1 NJ
preplace netloc processing_system7_0_axi_periph_M05_AXI 1 2 1 N
preplace netloc ARESETN_1 1 1 2 370 460 750
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 5 30 270 360 270 780 400 NJ 490 1640
preplace netloc processing_system7_0_IIC_0 1 4 1 NJ
preplace netloc axi_mem_intercon_M00_AXI 1 3 1 1200
preplace netloc rst_processing_system7_0_fclk0_peripheral_aresetn 1 1 3 370 1060 800 920 1250
preplace netloc processing_system7_0_axi_periph_M02_AXI 1 2 1 730
preplace netloc swsleds_gpio_GPIO2 1 4 1 NJ
preplace netloc hdmi_in_1 1 0 3 NJ 480 NJ 480 NJ
preplace netloc proc_sys_reset_fclk1_peripheral_aresetn 1 2 1 760
preplace netloc video_TMDS1 1 3 2 NJ 540 NJ
preplace netloc dvi2rgb_0_DDC 1 3 2 NJ 500 NJ
preplace netloc processing_system7_0_axi_periph_M06_AXI 1 2 2 730 740 NJ
...
preplace netloc S00_AXI_2 1 1 4 360 10 NJ 10 NJ 10 1670
preplace netloc axi_interconnect_0_M00_AXI 1 3 1 1240
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 1 2 380 470 740
preplace netloc processing_system7_0_FCLK_CLK0 1 0 5 40 660 390 1050 770 900 1230 460 1650
preplace netloc axi_interconnect_2_M00_AXI 1 2 1 720
preplace netloc axi_interconnect_1_M00_AXI 1 3 1 1230
preplace netloc rst_processing_system7_0_fclk0_interconnect_aresetn 1 1 2 370 490 820
preplace netloc processing_system7_0_FCLK_CLK1 1 1 4 400 450 830 390 1210 480 1660
preplace netloc axi_gpio_video_gpio_io_o 1 3 2 NJ 600 NJ
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 2 2 750 910 NJ
preplace netloc processing_system7_0_FCLK_CLK2 1 2 3 830 690 NJ 690 1670
preplace netloc concat_interrupts_dout 1 2 1 820
levelinfo -pg 1 0 200 560 1010 1440 1690 -top 0 -bot 1310
",
}
