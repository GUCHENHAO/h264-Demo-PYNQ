...
proc update_PARAM_VALUE.APB_AW { PARAM_VALUE.APB_AW } {
	# Procedure called to update APB_AW when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.APB_AW { PARAM_VALUE.APB_AW } {
	# Procedure called to validate APB_AW
	return true
}

proc update_PARAM_VALUE.APB_DW { PARAM_VALUE.APB_DW } {
	# Procedure called to update APB_DW when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.APB_DW { PARAM_VALUE.APB_DW } {
	# Procedure called to validate APB_DW
	return true
}
...
proc update_MODELPARAM_VALUE.APB_DW { MODELPARAM_VALUE.APB_DW PARAM_VALUE.APB_DW } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.APB_DW}] ${MODELPARAM_VALUE.APB_DW}
}

proc update_MODELPARAM_VALUE.APB_AW { MODELPARAM_VALUE.APB_AW PARAM_VALUE.APB_AW } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.APB_AW}] ${MODELPARAM_VALUE.APB_AW}
}
